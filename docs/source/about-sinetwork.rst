...
#. Ausschüttungen werden von den Koordinatoren regelmäßig veranlasst und in `DAI (Stablecoin) <https://medium.com/mycrypto/what-is-dai-and-how-does-it-work-742d09ba25d6>`_ an die Tokenhalter veranlasst.
...
Struktur des Social Impact Networks
-----------------------------------
...
Sie besteht aus einem Finanzteil auf einer Public Blockchain (Ethereum), das in Form eines `Social Impact Tokens (SI Token) <https://github.com/Social-Impact-Network/Frontend>`_ verfügbar ist und einem `transparenten Impact Measurement System (TIM) <https://github.com/Social-Impact-Network/Frontend>`_ , das die `Impact Werte <https://github.com/Social-Impact-Network/Frontend>`_ der Investmentprojekte sicher speichert.
Durch diese Struktur werden  die Finanzierungs- und Impact Measurment Prozesse transparenter nachvollziehbar und sicherer. Sie bieten den Investoren die Vorteile
der einfachen Handelbarkeit der Investments und zeigen authentisch die sozialen Vorteile des Investments.
...
.. list-table:: Elemente des Social Impact Networks
   ...
   * - Solar-Impact-Bridge
     ...
     - Die Solar-Impact-Bridge empfängt die Impact Werte der Solar Panels und speichert diese in der dezentralen BigChainDB.
   * - SI Node
     - Link...
   ...
   * - SI Token/Smart Contract
     ...
     - Der Smart Contract ist für die Erstellung des SI Token (ERC20 Token) sowie der Allokation und Verteilung der investierten Gelder zuständig.
...
Der SI Token verkörpert ein Wertpapier und entspricht dem legale Investment des Investors.
Der Investor kann den SI Token über die offizeille SI Plattform kaufen. Gehandelt werden kann der Token über dezentrale Börsen.
Die vereinnahmeten Gelder des SI Tokens werden von Aid Organizations (wie UNDP) für nachhaltige Investions Projekte verwendet. 
Dividendenauszahlungen finden in DAI statt.
Als ERC20 Token kann der SI Token innerhalb des Ethereum-Netzwerks frei versendet werden.
Der gesamte Investions und Ausschüttungsprozess und weitere Einzelheiten des SI Tokens können `hier <https://github.com/Social-Impact-Network/Frontend>`_ nachgelesen werden.
